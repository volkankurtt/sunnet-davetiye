...
export const eventConfig = {
  ...
  invitationTitle: 'Anlar Geçer Anılar Kalır',
  invitationMessage: 'Bu geceden size kalan güzel anılarınızı ve geceye bırakacağınız notları bizimle paylaşmayı unutmayın. 🧡',

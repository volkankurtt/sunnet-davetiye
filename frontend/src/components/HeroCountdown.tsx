...
export function HeroCountdown() {
  ...
  if (status === 'today') {
    return <p className="count-inline count-inline--msg">Bugün bizim özel günümüz</p>
  }

  if (status === 'past') {
    return <p className="count-inline count-inline--msg">Bu güzel günü birlikte yaşadık</p>
  }
